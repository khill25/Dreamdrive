...
void sd_sdio_ctor(sd_card_t *sd_card_p) {
    ...
    gpio_conf(sd_card_p->sdio_if.CLK_gpio, GPIO_FUNC_PIO0, true, false, true,  true, true);
    gpio_conf(sd_card_p->sdio_if.CMD_gpio, GPIO_FUNC_PIO0, true, false, true,  true, true);
    gpio_conf(sd_card_p->sdio_if.D0_gpio,  GPIO_FUNC_PIO0, true, false, false, true, true);
    gpio_conf(sd_card_p->sdio_if.D1_gpio,  GPIO_FUNC_PIO0, true, false, false, true, true);
    gpio_conf(sd_card_p->sdio_if.D2_gpio,  GPIO_FUNC_PIO0, true, false, false, true, true);
    gpio_conf(sd_card_p->sdio_if.D3_gpio,  GPIO_FUNC_PIO0, true, false, false, true, true);
