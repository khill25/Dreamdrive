...
void rp2040_sdio_init(sd_card_t *sd_card_p, int clock_divider)
{
    ...
    gpio_set_function(SDIO_CMD, GPIO_FUNC_PIO0);
    gpio_set_function(SDIO_CLK, GPIO_FUNC_PIO0);
    gpio_set_function(SDIO_D0, GPIO_FUNC_PIO0);
    gpio_set_function(SDIO_D1, GPIO_FUNC_PIO0);
    gpio_set_function(SDIO_D2, GPIO_FUNC_PIO0);
    gpio_set_function(SDIO_D3, GPIO_FUNC_PIO0);
